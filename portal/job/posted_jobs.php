...
$query = "SELECT * FROM jobs WHERE added_by = $companyId ";
                        ...
                        if ($flag):
                            foreach ($jobs as $job):
                                ...
                                <tr class="jobs-detail">
                                    ...
                                    <td>
                                        <?php if ($job['status']): ?>
                                            <a href="../update_status.php?type=job&id=<?php echo $job['id']; ?>&value=0"
                                            style="color: #27ae60;font-weight: bold;" title="click to disable"
                                            id="status-btn">LIVE</a>
                                        <?php else: ?>
                                            <a href="../update_status.php?type=job&id=<?php echo $job['id']; ?>&value=1"
