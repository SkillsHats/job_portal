				...
				<div class="header-right">
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							...
							<div class="profile-info" data-lock-name="NerdGeek Lab" data-lock-email="info@nerdgeeklab.com">
								<span class="name"><?php echo isset($_SESSION['user']) ? $_SESSION['user']  : 'ShyamBabu'  ?></span>
