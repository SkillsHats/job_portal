...
<html class="fixed">
	<head>
		...
		<meta name="keywords" content="Student Login" />
	...
	<body>
		...
		<section class="body-sign">
			<div class="center-sign">
				...
				<p class="text-center text-muted mt-md mb-md">&copy; Copyright 2018. All rights reserved. Template by <a href="http://nerdgeeklab.com">NerdGeek Lab</a>.</p>
			</div>
		</section>
