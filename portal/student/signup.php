					...
					<div class="panel-body">
						<form action="validate.php" method="POST">
							<div class="form-group mb-lg">
								<label>Name</label>
								<input name="name" type="text" class="form-control input" placeholder="username"/>
							</div>
							...
							<div class="row">
								...
								<div class="col-sm-4 text-right">
									<button type="submit" class="btn btn-primary hidden-xs" name="student_register">Sign Up</button>
									<button type="submit" class="btn btn-primary btn-block btn-lg visible-xs mt-lg" name="student_register">Sign Up</button>
								</div>
							</div>
							...
							<div class="mb-xs text-center">
								<h4>Employer <a href="../employer/signup.php">Signup</a></h4>
							</div>
