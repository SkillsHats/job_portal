						...
						<form action="validate.php" method="post">
							...
							<div class="row">
								...
								<div class="col-sm-4 text-right">
									<button type="submit" class="btn btn-primary hidden-xs" name="company_login">Sign In</button>
									<button type="submit" class="btn btn-primary btn-block btn-lg visible-xs mt-lg" name="company_login">Sign In</button>
								</div>
							</div>
							...
							<div class="mb-xs text-center">
								<h4>Student <a href="../student/signin.php">Signin</a></h4>
							</div>
